	...
	public class Test {
		...
		static void testForIllegalTags () {
			string[] legalTags = new string[] {
				...
				"self", "possession", "command", "happy", "sad", "love", "anger", "bored", "municipal", "continental", "planetary", "galactic", "universal", "sense", "see", "hear",
				"feel", "smell", "taste", "tiny", "small", "medium", "big", "large", "huge", "animal", "plant", "human", "alien", "living", "dead", "residential", "commercial",
				"industrial", "entertainment", "business", "nature", "governmental", "cold", "temperate", "warm", "hot", "past", "present", "start", "end", "future", "emotional",
				"physical", "digital", "virtual", "material", "spiritual", "social", "mental", "cultural",
